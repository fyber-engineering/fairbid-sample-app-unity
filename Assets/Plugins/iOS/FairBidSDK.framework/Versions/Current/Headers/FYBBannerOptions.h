 ...
 */
typedef NS_ENUM(NSUInteger, FYBFacebookBannerSize) {
    /**
     *  A fixed size 320x50 pt banner. Corresponds to kFBAdSize320x50.
     */
    //FYBFacebookBannerSize320x50 __attribute__((deprecated("Facebook has deprecated the 320x50 size."))),
    /**
...
typedef NS_ENUM(NSUInteger, FYBAdMobBannerSize){
     ...
     */
    FYBAdMobBannerSizeFlexibleWidthPortrait,
    /**
 ...
 *  iPhones: `FYBAppLovinBannerSizeBanner`
 *  iPads: `FYBAppLovinBannerSizeLeaderboard`
 */
@property (nonatomic) FYBAppLovinBannerSize appLovinBannerSize;
