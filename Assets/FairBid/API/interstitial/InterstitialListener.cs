...
{
    /// <summary>
    /// An Interface that contains the events triggered by an <see cref="Interstitial" />
    /// </summary>
    public interface InterstitialListener
    {
        ...
        /// <summary>
        /// Call when an ad is clicked on by the user.
        /// Expect the application to go into the background shortly after this callback is fired.
        /// </summary>
        /// <param name="placementId">The placement identifier for the particular ad.</param>
        ...
        /// <summary>
        /// Called when an interstitial ad is going to be requested.
        /// </summary>
        /// <param name="placementId">The identifier of the placement that was requested.</param>
        /// <param name="requestId">The identifier of the request across the whole request/show flow.</param>
        void OnRequestStart(string placementId, string requestId);
    }
}
