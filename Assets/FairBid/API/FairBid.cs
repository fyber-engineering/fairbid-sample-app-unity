...
namespace Fyber
{
    ...
    {
        public const string Version = "3.32.1";

        private const string CompatibleAndroidVersion = "3.32.0";
        private const string CompatibleIOSVersion = "3.32.1";
        ...
        public void Start()
        {
            if (!initialized)
            {
                    ...
                    #if UNITY_ANDROID
                        SetUserAChild(UserInfo.IsChild);
        ...
        private static void CheckNativeSDKCompatibility()
        {
                    ...
                    if (FairBidAndroid.SDKVersion() != CompatibleAndroidVersion) {
                        UnityEngine.Debug.LogError(String.Format("Invalid version of FairBid SDK for {0} integrated. Expected {1} found {2}", "Android", CompatibleAndroidVersion, FairBidAndroid.SDKVersion()));
        ...
        private static void InvokeCallback(CallbackInfo callbackInfo)
        {
            ...
            switch (callbackInfo.callback)
            {
                ...
                FairBid.fairBidListener.OnNetworkFailedToStart(MediatedNetworkFromString(network), callbackInfo.error);
                break;
            }
        }
        ...
        internal static MediatedNetwork MediatedNetworkFromString(string network)
        {
            ...
            {
                case "ADCOLONY":
                    return MediatedNetwork.ADCOLONY;
                case "ADMOB":
                ...
                case "TAPJOY":
                    return MediatedNetwork.TAPJOY;
                case "UNITYADS":
                    return MediatedNetwork.UNITYADS;
                case "VERVE":
                    return MediatedNetwork.VERVE;
                case "VUNGLE":
                    return MediatedNetwork.VUNGLE;
                case "YAHOO":
                    return MediatedNetwork.YAHOO;
