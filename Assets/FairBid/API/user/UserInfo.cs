...
namespace Fyber
{
    ...
    public class UserInfo : MonoBehaviour
    {
        ...
        /// <summary>
        /// We recommend using a certified CMP instead. If you do, FairBid SDK will read the correct values from the respective keys.
        /// If you prefer to use this API instead, it will take precedence over any value generated by a CMP.
